...
num_x = int(input("第x項 = "))
num_a1 = float(input("係數a1 = "))
num_a2 = float(input("係數a2 = "))
num_a3 = float(input("係數a3 = "))
num_p1 = float(input("係數p1 = "))
num_p2 = float(input("係數p2 = "))
num_ex1 = float(input("係數ex1 = "))
num_exp = float(input("指數底exp = "))
num_f0 = float(input("初始值f(0) = "))
num_f1 = float(input("初始值f(1) = "))
num_f2 = float(input("初始值f(2) = "))
